...
(function () {
  d3.timeline = function() {
    ...
    var hover = function () {},
        ...
        labelFunction2 = function(datum) {
          if (!(datum.times == undefined)){
            return datum.label;
          }
          var no = "";
          return no;
    ...
    var appendLabel = function (gParent, yAxisMapping, index, hasLabel, datum) {
      ...
      gParent.append("text")
        ...
        .text(hasLabel ? labelFunction2(datum) : datum.id)
    ...
    function timeline (gParent) {
      ...
      var xAxis = d3.svg.axis()
        ...
        //.tickValues([0]);
          //[291272400000, 388558800000, 757400400000, 979707600000, 1120152000000, 1132030800000, 1151208000000, 1181448000000, 1304481600000, 1370059200000]);
